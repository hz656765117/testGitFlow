...
<script type="text/javascript" src="${webPath}jsp/basicDataMng/academyMng/js/academy.js?v=2017030902"></script>
...
<%-- 				<a class="blue f12" style="margin-left:18px;" href="JavaScript:window.open('${webPath}/helps/helps_list_80.html')"><img src="${webPath}images/admin/grayquestion.png" class="ver-3 mr5">使用帮助</a> --%>
	    ...
	    <div class="mb10 mt10 searchVo">
				<form class=" form-inline form-inline-sm">
					<!-- 点击新建的时候是展示另外一个界面 -->
					<a role="button" class="btn btn-primary mr8" href="${webPath}basicDataMng/academyMng/toCreateAcademy.do"  >新建</a>
<!-- 					<a href="javascript:void(0);" onclick="delConfirm('all')" class="btn btn-default mr18 hui"><i class="ico-del-link icon-bg">批量删除</i></a> -->
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable caozuo  mb20 table">
					<tr>
							...
							<th class="text-left" width="10%">学院代码</th>
							<th class="text-left" width="50%">学院名称</th>
...
<!-- 选择判断是否的选择面板 -->
 ...
 <script type="text/javascript">
		...
		function delete_all(type,id){
			...
			//执行删除方法
			var url="${webPath}basicDataMng/academyMng/deleteAcademy.do?keyArr="+ids;
		...
		//获取修改面板		
		function getById (id){
			var url="${webPath}basicDataMng/academyMng/toUpdateAcademy.do?academyKey="+id;
			location = url;
		}
 </script>