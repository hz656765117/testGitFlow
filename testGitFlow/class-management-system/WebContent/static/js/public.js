...
jQuery(".user-pop").hide(); 
 ...
 posiLeft = (windowWidth-popupWeight)/2-1; 
...
function setHtml_x220x(){
	...
	jQuery(document.body).append('<div class="pos-abs pop-up bg-hui01 display-no w390 pt10" id="alertdiv_x220x_">'
			...
			+'<a href="javascript:void(0);" onclick="go_x220x()" class="f20 bai bg-lv-cur display-ib lh38 h38 bd-lv br4 text-center w120">是</a><a href="javascript:void(0)" onclick="closeDivTXL(\'_x220x_\')" class="f20 hui display-ib w120 btn-bg02 bd-hui01 lh38 h38 br4 text-center ml10">否</a>'
			+'</p>'
			+'</div>'
			+'</div>');
}
