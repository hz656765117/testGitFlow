        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                ...
                column = {
                    ...
                    width: ($.isNumeric(width)) ? width + "px" : 
                        (typeof(width) === "string") ? data.width : null
                };
    ...
    */
    ...
    Grid.defaults = {
        ...
        css: {
            ...
            right: "text-right",
            search: "btn btn-success", // must be a unique class name or constellation of class names within the header and footer
        ...
        labels: {
            all: "All",
            infos: "",//显示 {{ctx.start}} 至 {{ctx.end}} 总数{{ctx.total}}
            loading: "加载中",
            noResults: "没有记录",
            refresh: "刷新",
            search: " search"
