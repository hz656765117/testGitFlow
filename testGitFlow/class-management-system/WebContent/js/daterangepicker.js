...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        show: function (e) {
            ...
            $(document).on('click.daterangepicker',$.proxy(this.hideLayer, this)),
        ...
        hide: function (e) {
            ...
            this.container.hide();
            // 日历确定的回调函数方法
            //if (!this.startDate.isSame(this.oldStartDate) || !this.endDate.isSame(this.oldEndDate)) （第一次相同就会触发notify方法）  @update
                this.notify();
            this.oldStartDate = this.startDate.clone();
            this.oldEndDate = this.endDate.clone();
        ...
        clickCancel: function (e) {
            ...
            this.updateView();
            this.updateCalendars();
            //this.hide();// 删掉的代码，hide会触发回调函数  @update
            this.container.hide();//直接关闭谈曾  @update
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (!minDate || minDate.isBefore(calendar[1][1])) {
                html += '<th class="prev available"><i class="fa fa-arrow-left icon-arrow-left  glyphicon-arrow-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar[1][1])) {
                html += '<th class="next available"><i class="fa fa-arrow-right icon-arrow-right  glyphicon-arrow-right"></i></th>';
            } else {
                html += '<th></th>';
            }
