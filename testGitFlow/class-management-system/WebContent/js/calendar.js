/**
 * 代码来源：http://blog.jjonline.cn/userInterFace/173.html
 *
...
var calendar = {
	...
	/**
      ...
      */
	solar2lunar:function (solarDate) { //参数区间1900.1.31~2100.12.31
		if(solarDate!=null){
		 var solarDateStr  =  solarDate.replace(/-/g,"");
		 var y = solarDateStr.substr(0,4);
		 var m = solarDateStr.substr(4,2);
		 var d = solarDateStr.substr(6,2);
	...
	fmtRstDate:function(obj){
		...
		var IMonthCn = obj.IMonthCn;
		var IDayCn = obj.IDayCn;
		return  {"ymd":y+"-"+m+"-"+d,'lunar':IMonthCn+IDayCn};
	}
