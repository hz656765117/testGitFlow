...
public class Paginator implements java.io.Serializable {
	...
	private static final long serialVersionUID = 5161805449976095724L;
	 ...
	 * 静态构造方法
	 */
	public static Paginator of(int page, int pageSize) {
	 ...
	 * 静态构造方法
	 */
	public static Paginator of(int page, int pageSize, int totalItems) {
		Paginator p = new Paginator();
		p.setPage(page);
		p.setPageSize(pageSize);
	...
	private Paginator(int page, int pageSize, int totalItems) {
		super();
		this.pageSize = pageSize;
		this.totalItems = totalItems;
    ...
    public int getLimit(){
    	if (page > 0) {
			return Math.min(pageSize, getTotalItems());
		} else {
			return 0;
		}
    }
	...
	public String toString() {
		return "page:" + page + " pageSize:" + pageSize + " totalItems:"
				+ totalItems;
	}
