...
import com.hz.business.basicDataMng.base.pojo.MajorPOExample.Criteria;
...
public class ClassPOExample {
    ...
    public static class Criteria extends GeneratedCriteria {
		...
		public Criteria andListLikeTo(String className) {
			className=className==null?"":className;
			 addCriterion("t.class_name like '%"+className+"%'");
	         return (Criteria) this;
		}
    }
